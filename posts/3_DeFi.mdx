---
title: Onboarding into primitive DeFi strategies
description: Decentralized finance primitives to understand the market (smart contracts).
---

- Stablecoins: Stablecoins are cryptocurrencies designed to maintain a stable value relative to a specific asset, usually a fiat currency. Examples include Dai (pegged to the U.S. dollar) and USDT (pegged to the U.S. dollar). Stablecoins provide stability and can be used for trading, lending, and as a store of value within the DeFi ecosystem.
